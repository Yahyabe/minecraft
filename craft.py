...
grass_texture = load_texture("assets/yer.png")
soil_texture = load_texture("assets/wood.png")
stone_texture = load_texture("assets/stone1.jpg")
wood_texture = load_texture("assets/wool.jpg")


sky_texture = load_texture("assets/sky2.png")
